...
#Region "Initialize & Object Function"
    ...
    Private Sub TableInitialize()
        Dim TMPRecord As FbDataReader
        Try
            TMPRecord = MyDatabase.MyReader("SELECT * FROM TABLELIST T LEFT OUTER JOIN FLOORNO F ON T.FLOORNOUID=F.FLOORNOUID WHERE T.IMAGE NOT IN ('9','10','5','6','7','8') AND F.FLOORDEPTUID ='" & DeptInfo.DeptUID & "' AND (TABLELISTACTV IS NULL OR TABLELISTACTV = 0 ) ORDER BY TABLELISTNAME")
