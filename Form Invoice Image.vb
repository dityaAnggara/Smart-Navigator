...
#Region "Variable Reference"
  ...
  Dim SellItemUiddua As String
  Dim oNoFftimer As Boolean = False
#End Region
...
#Region "Initialize & Object Function"
    ...
    Dim oBjfC As New Form_Custm_Display_MakeBill


    'Dim getcurnt As Integer = 0
    'getcurnt = OrderDetail.Row
    ...
    'Timer1.Enabled = True
      ...
      'SellItemUiddua = CStr(arrayData(1))
            ...
            If EditStatus = True Then
              ...
              'ItemuIdFormCustomerDisplay = OrderDetail.Item(getcurnt, 1).ToString()
              'ItemQTYFormCustomerDisplay = OrderDetail.Item(getcurnt, 2).ToString()
              'ItemNameFormCUstomerDisplay = OrderDetail.Item(getcurnt, 3).ToString()
              'ItemAmountFormCustomerDisplay = OrderDetail.Item(getcurnt, 5).ToString()
              ItemMixFormCustomerDisplay = .Item(.Row, 1).ToString & "?" & .Item(.Row, 2) & "?" & .Item(.Row, 3).ToString & "?" & .Item(.Row, 5) & "?Plus" & "? " & "? "
            End If
            'MessageBox.Show(.Item(.Row, 3).ToString)
            Call Button1_Click(sender, e)
            Application.DoEvents()
        ...
        If Form_Detail_Menu.dftItem <> "" Then
          ...
          With OrderDetail
            ...
            'MessageBox.Show(Form_Detail_Menu.dftItem)
            Dim arrData() As String
            ...
            'pSahSplit = selItemName.Split("+")

            'sPlitArt = Trim(pSahSplit(0))

            'pSahpArt = ""
            'For KountAre As Integer = 1 To pSahSplit.Count() - 1

            '  pSahpArt = pSahpArt + "+" + Trim(pSahSplit(KountAre))
            'Next
            'pSahpArt = pSahpArt.Replace(vbCr, "").Replace(vbLf, "")
            ''MessageBox.Show(pSahpArt)
            ...
            For i As Integer = 0 To UBound(arrBarang) - 1
              ...
              If Trim(arrDetailBarang(3)) <> "-" Then
                ...
                cR.Style = .Styles("string")
              End If
              'MessageBox.Show(arrDetailBarang(4))

              pSahpArtB = pSahpArtB + "+" + arrDetailBarang(4)
            Next
            'MessageBox.Show(pSahpArtB)
            pSahSplit = selItemName.Split("+")
    ...
    Private Sub SimpanDetailNewMB()
        ...
        For ins = 1 To NEWOrderListCollection.Count
            ...
            'Susilo, 2 Maret 2015, diganti karena ada modifier
        ...
        For i As Integer = 1 To NEWOrderListCollection.Count
            ...
            While RecordItem.Read
                If CInt(RecordItem.Item(0)) > 0 Then
                    ...
                    '    End While
                    'End If
                    'Susilo, 2 Maret 2015, dirubah karena ada modifier
                    If InStr(ListArray(2), vbNewLine & "   +") <> 0 Then
                        Dim arrItem() As String = Split(ListArray(2), vbNewLine & "   +")
                        nmItem = arrItem(0)
                        listNote = Replace(Replace(ListArray(2), nmItem & vbNewLine & "   +", ""), vbNewLine & "   +", MY_SUB_DELIMITER)
...
#Region "Form Control Function"
    ...
    Private Sub BTNMakeBill_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTNMakeBill.Click
        ...
        If OrderDetail.Rows.Count > 1 Then
          ...
          ''ditutup sementara karena trial demo
    ...
    'Call Form Make Bill
    FoundMakeBillForm = "edan"
    Me.Cursor = Cursors.WaitCursor
    'Form_Custm_Display_MakeBill.TextBox1.Text = DiscountFromMakeBillFCDP

    'Dim ObjNewTw As New Form_Custm_Display_MakeBill

    'ObjNewTw.Name = "Form_Custm_Display_MakeBill"
    'ObjNewTw.VarContoh = "True"
    'Dim screenx As Screen
    'screenx = Screen.AllScreens(0)
    'ObjNewTw.Location = screenx.Bounds.Location + New Point(100, 100)
    'ObjNewTw.Show()
    ...
    Me.Close()
    'Call Form_Custm_Display_MakeBill.closeThisform()
  End Sub
    ...
    With OrderDetail
      ...
      While rs.Read = True
        If IsDBNull(rs("INVENPARENTUID")) = False Or CLng(rs("jmlModItem")) > 0 Then
          ...
          Form_Detail_Menu.harga = .Item(tmpRow, 4)
...
#End Region
    ...
    'Form_Custm_Display_MakeBill.TextBox1.Text = OrderDetail.Item(1, 3).ToString()
  ...
  Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
    ...
    If OrderDetail.Rows.Count > 1 Then
      ...
      If ItemIdentifyClick = "mod" Then
        ...
        ItemAmountFormCustomerDisplay = OrderDetail.Item(getcurnt, 5).ToString()
        PlusForModItem = OrderDetail.Item(getcurnt, 14).ToString()
      ...
      ItemMixFormCustomerDisplay = ItemuIdFormCustomerDisplay & "?" & ItemQTYFormCustomerDisplay & "?" & Trim(ItemNameFormCUstomerDisplay) & "?" & ItemAmountFormCustomerDisplay & "?" & ItemIdentifyClick & "?" & pSahpArt & "?" & PlusForModItem
      'MessageBox.Show(ItemMixFormCustomerDisplay)
    End If
  End Sub
  ...
  Private Sub Timer1_Tick(ByVal sender As Object, ByVal e As System.EventArgs) Handles Timer1.Tick
    ...
    '  ItemMixFormCustomerDisplay = ItemuIdFormCustomerDisplay & "+" & ItemQTYFormCustomerDisplay & "+" & ItemNameFormCUstomerDisplay & "+" & ItemAmountFormCustomerDisplay
    '  'Timer1.Enabled = False
    'End If
  End Sub
  
  Private Sub ButtonTriger_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles ButtonTriger.Click
    ...
    ItemMixFormCustomerDisplay = ItemuIdFormCustomerDisplay & "+" & ItemQTYFormCustomerDisplay & "+" & ItemNameFormCUstomerDisplay & "+" & ItemAmountFormCustomerDisplay & "?" & "plus" & "?" & "" & "?" & ""
  End Sub
End Class