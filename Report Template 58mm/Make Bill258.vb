...
Public Class Make_Bill258
    ...
    Private Sub Detail1_Format(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Detail1.Format
        ...
        '    BillNoLabel.Value = ""
        'Else
        BillNoLabel.Value = BillNoLabel.Value
        'End If
        ...
        If IsDBNull(SubTotalFood.Value) Then
            SubTotalFood.Value = "0.00"
        Else
            SubTotalFood.Value = FormatNumber(SubTotalFood.Text, 2, , , TriState.True)
        End If
        If IsDBNull(SubTotalBeverage.Value) Then
            SubTotalBeverage.Value = "0.00"
        Else
            SubTotalBeverage.Value = FormatNumber(SubTotalBeverage.Text, 2, , , TriState.True)
        End If
        If IsDBNull(SubTotalMenuEtc.Value) Then
            SubTotalMenuEtc.Value = "0.00"
        Else
            SubTotalMenuEtc.Value = FormatNumber(SubTotalMenuEtc.Text, 2, , , TriState.True)
        End If
    ...
    Private Sub ReportFooter1_Format(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ReportFooter1.Format
        ...
        'Harys - 8 Okt 2011
        Dim GrandTotal As Decimal = 0
        GrandTotal = Val(BillSubTotalLabel.Text) + Val(TotalDisc) + Val(BillPPNLabel.Text) + Val(BillSCLabel.Text)
        ...
        LabelDP.Visible = False : BillDPLabel.Visible = False
        'Else
