...
Public Class Make_Bill_Sub_Item58
    ...
    Private Sub Detail1_Format(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Detail1.Format
        ...
        If BillItemDisc1.Value <> 0 And BillItemDisc2.Value <> 0 Then
            ...
            BillItemDisc1.Value = "-" & FormatNumber(BillItemDisc1.Value, DijitKoma, , , TriState.True)
            BillItemDisc2.Value = "-" & FormatNumber(BillItemDisc2.Value, DijitKoma, , , TriState.True)
        End If
