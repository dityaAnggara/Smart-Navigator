...
Public Class Make_Order58
    ...
    Private Sub Detail1_Format(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Detail1.Format
        ...
        MakeOrderTransactionDateLabel.Text = Format(MakeOrderTransactionDateLabel.Value, "dd/MM/yyyy HH:mm")
        MakeOrderTransNoLabel.Value = MakeOrderTransNoLabel.Value & " " & MakeOrderTransactionDateLabel.Text
        ...
        SubItem = New Make_Order_Sub_Item58
        ...
        If Trim(pubQueryLap) = "" Then
            ...
            Make_Order_Sub_Item58.publicMustPrintNotes = False
        Else
            DataPoint = MyDatabase.MyAdapter(pubQueryLap)
            Make_Order_Sub_Item58.publicMustPrintNotes = pubHarusCetakNotes
        End If
