...
Public Class Make_Bill
    ...
    Private Sub Detail1_Format(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Detail1.Format
        ...
        If IsDBNull(BillTotalDiscLabel.Value) Then
            ...
            BillTotalDiscLabel.Value = FormatNumber(0, DijitKoma)
        Else
            TotalDisc = BillTotalDiscLabel.Value
        ...
        SubItem = New Make_Bill_Sub_Item
    ...
    Private Sub ReportFooter1_Format(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ReportFooter1.Format
        ...
        'BillSubTotalLabel.Value = FormatNumber(CDec(BillSubTotalLabel.Text) + CDec(TotalDisc), 2, , , TriState.True)
        'BillTotalDiscLabel.Value = FormatNumber(BillTotalDiscLabel.Text, 2, , , TriState.True)
        'BillPPNLabel.Value = FormatNumber(Val(BillPPNLabel.Text), 2, , , TriState.True)
        'BillSCLabel.Value = FormatNumber(Val(BillSCLabel.Text), 2, , , TriState.True)
        'BillDPLabel.Value = FormatNumber(BillDPLabel.Text, 2, , , TriState.True)
        'TotalNetLabel.Value = FormatNumber(GrandTotal, 2, , , TriState.True)

        'FooterMsg.Text = PrefInfo.Footer

        'Harys - 8 Okt 2011
        Dim GrandTotal As Decimal = 0
    GrandTotal = Val(BillSubTotalLabel.Text) + Val(TotalDisc) + Val(BillPPNLabel.Text) + Val(BillSCLabel.Text) - Val(BillDPLabel.Text) + Val(RoundLabel.Text)
    ...
    RoundLabel.Value = FormatNumber(RoundLabel.Text, DijitKoma, , , TriState.True)
        If ShowPreSettledBill Then
    ...
    If PrefInfo.UseRounding = True Then
      LabelRounding.Visible = True
      LabelRounding.Text = "Rounding :"
      RoundLabel.Visible = True

    Else
      LabelRounding.Visible = False
    ...
    If LabelSC.Visible = False And LabelPPN.Visible = False And LabelDP.Visible = False And LabelRounding.Visible = False Then
    ...
    ElseIf LabelSC.Visible = True And LabelPPN.Visible = False And LabelDP.Visible = False And LabelRounding.Visible = False Then
    ...
    ElseIf LabelSC.Visible = True And LabelPPN.Visible = True And LabelDP.Visible = False And LabelRounding.Visible = False Then
    ...
    ElseIf LabelSC.Visible = False And LabelPPN.Visible = True And LabelDP.Visible = True And LabelRounding.Visible = False Then
      ...
      CurrentDateLabel.Location = New Drawing.PointF(1.188, 0.938)
      FooterMsg.Location = New Drawing.PointF(0.063, 1.188)
    ElseIf LabelSC.Visible = False And LabelPPN.Visible = False And LabelDP.Visible = True And LabelRounding.Visible = False Then
      ...
      CurrentDateLabel.Location = New Drawing.PointF(1.188, 0.75)
      FooterMsg.Location = New Drawing.PointF(0.063, 1.063)
    ElseIf LabelSC.Visible = True And LabelPPN.Visible = False And LabelDP.Visible = True And LabelRounding.Visible = False Then
      ...
      CurrentDateLabel.Location = New Drawing.PointF(1.188, 0.938)
      FooterMsg.Location = New Drawing.PointF(0.063, 1.188)
    ElseIf LabelSC.Visible = False And LabelPPN.Visible = True And LabelDP.Visible = False And LabelRounding.Visible = False Then
      LabelPPN.Location = LabelSC.Location : BillPPNLabel.Location = BillSCLabel.Location
      ...
      CurrentDateLabel.Location = New Drawing.PointF(1.188, 0.75)
      FooterMsg.Location = New Drawing.PointF(0.063, 1.063)
    ElseIf LabelSC.Visible = False And LabelPPN.Visible = False And LabelDP.Visible = False And LabelRounding.Visible = True Then
      LabelRounding.Location = LabelDP.Location : RoundLabel.Location = BillDPLabel.Location
      LabelTotalNet.Location = New Drawing.PointF(0.063, 0.438) : TotalNetLabel.Location = New Drawing.PointF(1.188, 0.438)
      Line6.X1 = 0.06 : Line6.X2 = 2.44 : Line6.Y1 = 0.69 : Line6.Y2 = 0.69
      BillPrintUserLabel.Location = New Drawing.PointF(0.063, 0.75)
      CurrentDateLabel.Location = New Drawing.PointF(1.188, 0.75)
      FooterMsg.Location = New Drawing.PointF(0.063, 1.063)
    ElseIf LabelSC.Visible = True And LabelPPN.Visible = True And LabelDP.Visible = True And LabelRounding.Visible = False Then
      LabelTotalNet.Location = LabelRounding.Location : TotalNetLabel.Location = RoundLabel.Location
      'Line6.X1 = 0.06 : Line6.X2 = 2.44 : Line6.Y1 = 0.69 : Line6.Y2 = 0.69
      'BillPrintUserLabel.Location = New Drawing.PointF(0.063, 0.75)
      'CurrentDateLabel.Location = New Drawing.PointF(1.188, 0.75)
      'FooterMsg.Location = New Drawing.PointF(0.063, 1.063)
    ElseIf LabelSC.Visible = False And LabelPPN.Visible = False And LabelDP.Visible = True And LabelRounding.Visible = True Then
      LabelDP.Location = LabelSC.Location : BillDPLabel.Location = BillSCLabel.Location
      LabelRounding.Location = LabelPPN.Location : RoundLabel.Location = BillPPNLabel.Location
      LabelTotalNet.Location = New Drawing.PointF(0.063, 0.625) : TotalNetLabel.Location = New Drawing.PointF(1.188, 0.625)
      Line6.X1 = 0.06 : Line6.X2 = 2.44 : Line6.Y1 = 0.88 : Line6.Y2 = 0.88
      BillPrintUserLabel.Location = New Drawing.PointF(0.063, 0.938)
      CurrentDateLabel.Location = New Drawing.PointF(1.188, 0.938)
      FooterMsg.Location = New Drawing.PointF(0.063, 1.188)
    ElseIf LabelSC.Visible = True And LabelPPN.Visible = False And LabelDP.Visible = True And LabelRounding.Visible = True Then
      LabelDP.Location = LabelPPN.Location : BillDPLabel.Location = BillPPNLabel.Location
      LabelRounding.Location = New Drawing.PointF(0.063, 0.625) : RoundLabel.Location = New Drawing.PointF(1.188, 0.625)
      LabelTotalNet.Location = New Drawing.PointF(0.063, 0.813) : TotalNetLabel.Location = New Drawing.PointF(1.188, 0.813)
      Line6.X1 = 0.06 : Line6.X2 = 2.44 : Line6.Y1 = 1 : Line6.Y2 = 1
      BillPrintUserLabel.Location = New Drawing.PointF(0.063, 1.09)
      CurrentDateLabel.Location = New Drawing.PointF(1.188, 1.09)
      FooterMsg.Location = New Drawing.PointF(0.063, 1.29)
    ElseIf LabelSC.Visible = False And LabelPPN.Visible = True And LabelDP.Visible = True And LabelRounding.Visible = True Then
      LabelPPN.Location = LabelSC.Location : BillPPNLabel.Location = BillSCLabel.Location
      LabelDP.Location = New Drawing.PointF(0.063, 0.438) : BillDPLabel.Location = New Drawing.PointF(1.188, 0.438)
      LabelRounding.Location = New Drawing.PointF(0.063, 0.625) : RoundLabel.Location = New Drawing.PointF(1.188, 0.625)
      LabelTotalNet.Location = New Drawing.PointF(0.063, 0.813) : TotalNetLabel.Location = New Drawing.PointF(1.188, 0.813)
