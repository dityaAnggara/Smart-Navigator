...
Public Class Cash_In_Out
  ...
  Private Sub Detail1_Format(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Detail1.Format
    BillNoLabel.Text = BillNoLabel.Text & "   " & TransactionDateLabel.Text
    txtPaymentType.Text = "Tipe Pembayaran : " & txtPaymentType.Text
    txtTipeTransaksi.Text = "Tipe Transaksi  : " & txtTipeTransaksi.Text
    Label1.Text = FormatNumber(IIf(Val(Label1.Text) < 0, Val(Label1.Text) * (-1), Val(Label1.Text)), DijitKoma, , , TriState.True)
  End Sub
End Class
