...
Public Class Make_Order_Split
    ...
    Private Sub Detail1_Format(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Detail1.Format
        ...
        SubItem = New Make_Order_Sub_Item_Split
        ...
        If Trim(pubQueryLap) = "" Then
            ...
            Make_Order_Sub_Item_Split.publicMustPrintNotes = False
        Else
            DataPoint = MyDatabase.MyAdapter(pubQueryLap)
            Make_Order_Sub_Item_Split.publicMustPrintNotes = pubHarusCetakNotes
        End If
