...
Public Class Make_Order 
    ...
    Private Sub Detail1_Format(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Detail1.Format
        ...
        MakeOrderTransNoLabel.Value = "NO : " & MakeOrderTransNoLabel.Value
        MakeOrderTransactionDateLabel.Text = Format(MakeOrderTransactionDateLabel.Value, "dd/MM/yyyy hh:mm tt")
        ...
        MakeOrderPaxLabel.Text = "PAX : " & MakeOrderPaxLabel.Value

        MakeOrderModifiedUserLabel.Value = "OP : " & MakeOrderModifiedUserLabel.Value
        ...
        SubItem = New Make_Order_Sub_Item
        ...
        If Trim(pubQueryLap) = "" Then
            ...
            Query = "SELECT a.MBTRANSDTITEMNAME AS MBTRANSDTITEMNAME,a.MBTRANSDTITEMNOTE,a.MBTRANSDTISTAKEAWAY,a.MBTRANSDTITEMNAME||ASCII_CHAR(13)||IIF(MBTRANSDTLISTNOTE IS NULL OR TRIM(MBTRANSDTLISTNOTE)='','','+'||REPLACE(a.MBTRANSDTLISTNOTE,'^#@$^',ASCII_CHAR(13)||'+')) AS MBTRANSDTITEMLISTNOTE, a.MBTRANSDTUID, a.MBTRANSDTITEMNAME, a.MBTRANSDTITEMQTY,b.MBTRANSDTITEMNAME AS DETAILITEM,b.MBTRANSDTITEMQTY AS DETAILQTY " & _
                   "FROM MBTRANSDT a LEFT OUTER JOIN MBTRANSDTDETAIL b ON b.MBTRANSDTUID=a.MBTRANSDTUID " & _
                   "WHERE MBTRANSUID ='" & Label33.Text & "' AND a.PRINT=1  AND MBTRANSDTPARENTUID IS NULL"
            DataPoint = MyDatabase.MyAdapter(Query)
            Make_Order_Sub_Item.publicMustPrintNotes = False
            Make_Order_Sub_Item.isViewChild = True
        Else
            DataPoint = MyDatabase.MyAdapter(pubQueryLap)
            Make_Order_Sub_Item.publicMustPrintNotes = pubHarusCetakNotes
            Make_Order_Sub_Item.isViewChild = False
        End If
