...
Partial Public Class Make_Order_Split
    ...
    Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(Make_Order_Split))
    ...
    Me.Detail1.Controls.AddRange(New DataDynamics.ActiveReports.ARControl() {Me.MakeOrderPrintUserLabel, Me.Line3, Me.SubReport1, Me.MakeOrderTableLabel, Me.Label33, Me.Line1, Me.CurrentDateLabel})
