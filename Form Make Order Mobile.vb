...
#Region "Initialize & Object Function"
    ...
    Private Sub SettingAccess(ByVal Access As Boolean)
        ...
        panelCategory.Enabled = Access
        panelMenu.Enabled = Access
    ...
    Private Sub ResetAll(Optional ByVal All As Boolean = True)
        If All Then
            For Each OBJ As Object In panelCategory.Controls
        ...
        End If
        For Each OBJ As Object In panelMenu.Controls
            If TypeOf OBJ Is C1Input.C1Button Then
    ...
    Private Sub CategoryList(ByVal Position As Long)
        ...
        If CatCollection.Count > 14 Then
            LoopFrom = Position
            If Position + 13 > CatCollection.Count Then
        ...
        If Position > 0 Then
            For i As Integer = LoopFrom To LoopTo
                ...
                CurOBJIndex = IIf(i > 14, (i Mod 2), i)
                CurOBJIndex = IIf(CurOBJIndex = 0, 14, CurOBJIndex)
        ...
        BackCategory.Enabled = Position > 14
        NextCategory.Enabled = CatCollection.Count > Position + 13
    ...
    Private Sub CategoryClick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Category1.Click, Category2.Click, Category3.Click, Category4.Click, Category5.Click, Category6.Click, Category7.Click, _
        Category8.Click, Category9.Click, Category10.Click, Category11.Click, Category12.Click, Category13.Click, Category14.Click        
        Me.Cursor = Cursors.WaitCursor
        Dim OBJNew As New Form_Make_Order_Mobile
        OBJNew.Name = "InvoiceMobileDetailMenu"
        OBJNew.Tag = sender.tag
        OBJNew.ShowDialog()
        Call fillGridFromTxtFile()
        If OrderDetail.Rows.Count > 1 Then BTNMakeBill.Enabled = True : BTNMakeBill.VisualStyle = C1Input.VisualStyle.Office2007Blue Else BTNMakeBill.Enabled = False : BTNMakeBill.VisualStyle = C1Input.VisualStyle.Office2007Silver
        Me.Cursor = Cursors.Default
    End Sub

    Private Sub ItemClick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Item01.Click, Item02.Click, Item03.Click, Item04.Click, Item05.Click, Item06.Click, Item07.Click, Item08.Click, Item09.Click, Item10.Click, Item11.Click, Item12.Click, _
        Item13.Click, Item14.Click, Item15.Click, Item16.Click
        ...
        If UBound(arrayData) >= 5 Then
            ...
            With OrderDetail
                ...
                If Not Bypas Then
                    ...
                    End If
                    Application.DoEvents()
                    Dim objForm As New Form_Popup_Jumlah
                    objForm.Name = "Form_Popup_Jumlah"
                    objForm.ShowDialog()
                    If objForm.PubJmlMenu = 0 Then Exit Sub
                    .AddItem(vbTab & selItemUID & vbTab & objForm.PubJmlMenu.ToString & vbTab & selItemName & vbTab & selItemPrice & vbTab & CStr(CDec(selItemPrice) * CDec(objForm.PubJmlMenu)) & vbTab & vbTab & vbTab & vbTab & vbTab & vbTab & selItemLevel & vbTab & selItemMeas)
                    .Rows(.Rows.Count - 1).Height = 45
                    .Row = .Rows.Count - 1
                    Application.DoEvents()
                    Call ShowPoleDisplay(Mid(selItemName, 1, 18), False)
    ...
    Private Sub ReInitializePrice()
        ...
        Tax1ValTxt.Value = FormatNumber((((CDec(SubTotalTxt.Text)) * CDec(Tax1Txt.Value)) / 100), 0)
        Tax2ValTxt.Value = FormatNumber((((CDec(SubTotalTxt.Text) + CDec(Tax1ValTxt.Value)) * CDec(Tax2Txt.Value)) / 100), 0)

        TotalGlobal = CDec(SubTotalTxt.Text) + CDec(Tax1ValTxt.Value) + CDec(Tax2ValTxt.Value)
    ...
    Private Sub QTYUpdate(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles QTY01.Click, QTY02.Click, QTY03.Click, QTY04.Click, QTY05.Click, QTY06.Click, QTY07.Click, QTY08.Click, QTY09.Click, QTY10.Click
        With OrderDetail
            If .Rows.Count > 1 Then
                ...
                Application.DoEvents()
                Call ShowPoleDisplay(Mid(.Item(.Row, 2) & "x" & .Item(.Row, 3), 1, 18), False)
    ...
    Private Sub QtyCalculator_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles QtyCalculator.Click
        If OrderDetail.Row > 0 Then
            ...
            Application.DoEvents()
            Call ShowPoleDisplay(Mid(OrderDetail.Item(OrderDetail.Row, 2) & "x" & OrderDetail.Item(OrderDetail.Row, 3), 1, 18), False)
    ...
    Private Sub SimpanDetailExistingMB(ByVal InputMBTransUID As String)
        ...
        oldModifiedTime = Format(Now, "dd.MM.yyyy, HH:mm:ss")
        Call MyDatabase.MyAdapter("UPDATE MBTRANS SET MBTRANSDPVAL='" & nilaiDP & "',MODIFIEDDATETIME='" & Format(Now, "dd.MM.yyyy, HH:mm:ss") & "',MBTRANSRSVTRANSUID=" & IIf(tmpRSV = Nothing, "NULL", "'" & tmpRSV & "'") & ",MBTRANSCUSTUID='" & CustomerUID.Text & "',MBTRANSCUSTNAME='" & ReplacePetik(CustomerNameLabel.Text) & "' WHERE MBTRANSUID='" & InputMBTransUID & "'")
...
#Region "Form Control Function"
    ...
    Private Sub Form_Make_Order_Mobile_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Me.Load
        If screenWidth < 1024 Then
            ...
            If Me.Name = "InvoiceMobile" Then
                dtabCategory.Height = 577
                dtabAtas.Scale(fSize) : panelAtas.Scale(fSize)
                dtabCategory.Scale(fSize) : panelCategory.Scale(fSize)
                dtabBawah.Scale(fSize) : panelBawah.Scale(fSize)
                panelAtasMenu.Visible = False
                panelMenu.Visible = False
            ElseIf Me.Name = "InvoiceMobileDetailMenu" Then
                panelAtas.Visible = False
                panelAtasMenu.Left = panelAtas.Left
                GroupOrder.Visible = False
                GroupBox3.Visible = False
                panelCategory.Visible = False
                panelMenu.Left = panelCategory.Left
                dtabCategory.Height = 656
                panelBawah.Visible = False
                dtabBawah.Visible = False
                dtabAtas.Scale(fSize) : dtabCategory.Scale(fSize)
                panelAtasMenu.Scale(fSize) : panelAtas.Scale(fSize)
                panelMenu.Scale(fSize) : panelCategory.Scale(fSize)
                panelAtasMenu.Visible = True
                panelMenu.Visible = True
                Call fillGridFromTxtFile()
            ElseIf Me.Name = "InvoiceMobileViewOrder" Then
                Dim rs As FbDataReader
                rs = MyDatabase.MyReader("SELECT MBTRANSSTAT FROM MBTRANS WHERE MBTRANSUID='" & TransactionUID & "'")
                If rs.Read = True Then
                    If rs("MBTRANSSTAT") <> "0" Then
                        QTYMinus.Enabled = False : QTYMinus.Enabled = False : BTNNotes.Enabled = False : BTNTakeAway.Enabled = False : BTNRemove.Enabled = False
                        QTYMinus.VisualStyle = C1Input.VisualStyle.Office2007Silver : QTYMinus.VisualStyle = C1Input.VisualStyle.Office2007Silver
                        BTNNotes.VisualStyle = C1Input.VisualStyle.Office2007Silver : BTNTakeAway.VisualStyle = C1Input.VisualStyle.Office2007Silver : BTNRemove.VisualStyle = C1Input.VisualStyle.Office2007Silver
                    End If
                End If
                rs = Nothing

                panelCategory.Visible = False
                dtabAtas.Visible = False
                panelAtas.Visible = False
                panelCategory.Visible = False
                panelBawah.Visible = False
                dtabCategory.Visible = False
                dtabBawah.Visible = False
                GroupOrder.Left = dtabCategory.Left
                GroupBox3.Left = 2
                GroupOrder.Scale(fSize)
                GroupBox3.Scale(fSize)
                Call fillGridFromTxtFile()
            End If
        End If
        ...
        If Me.Name = "InvoiceMobileDetailMenu" Then
    ...
    Private Sub saveTxtFile()
        Dim fileName As String = Path.GetTempPath & "\txtOrder.txt"
        Using sw As StreamWriter = File.CreateText(fileName)
            With OrderDetail
                For i As Integer = 1 To .Rows.Count - 1
                    Dim tmpRow As String = vbTab
                    For j As Integer = 1 To .Cols.Count - 1
                        tmpRow = tmpRow & .Item(i, j) & vbTab
                    Next
                    sw.WriteLine(tmpRow)
                Next
            End With
    ...
    Private Sub fillGridFromTxtFile()
        If File.Exists(Path.GetTempPath & "\txtOrder.txt") = False Then Exit Sub
        With OrderDetail
            .Rows.Count = 1
            Using sr As StreamReader = File.OpenText(Path.GetTempPath & "\txtOrder.txt")
                Do While sr.Peek() >= 0
                    Dim tmpRow As String
                    tmpRow = sr.ReadLine().ToString
                    If Trim(tmpRow) <> "" Then
                        Dim arrRow() As String
                        arrRow = tmpRow.Split(vbTab)
                        If Trim(arrRow(3)) <> "" Then
                            .AddItem(tmpRow)
                            .Rows(.Rows.Count - 1).Height = 47
                            .Row = .Rows.Count - 1
                            Application.DoEvents()
                        End If
                    End If
    ...
    Private Sub BTNClose_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTNClose.Click
        File.Delete(Path.GetTempPath & "\txtOrder.txt")
        If Authorize = True Then
            Authorize = False
            UserInformation.UserInitialize(UUID, UName, UOrderPoint, UTypeUID, UDeptUID)
            Call MainPage.StatusBarInitialize()
...
#End Region
    ...
    Private Sub cmdGotoPageCategory_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdGotoPageCategory.Click
        Call saveTxtFile()
        Me.Close()
    End Sub

    Private Sub cmdViewOrder_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdViewOrder.Click
        Me.Cursor = Cursors.WaitCursor
        Dim OBJNew As New Form_Make_Order_Mobile
        OBJNew.Name = "InvoiceMobileViewOrder"
        OBJNew.ShowDialog()
        Me.Cursor = Cursors.Default
        Dim ItemRecord As FbDataReader
        ItemRecord = MyDatabase.MyReader("SELECT MODIFIEDDATETIME FROM MBTRANS WHERE MBTRANSUID='" & TransactionUID & "'")
        If ItemRecord.Read = True Then oldModifiedTime = Format(ItemRecord.Item("MODIFIEDDATETIME"), "dd.MM.yyyy, HH:mm:ss")
        ItemRecord = Nothing
    End Sub

    Private Sub cmdViewOrderDetail_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdViewOrderDetail.Click        
        Me.Cursor = Cursors.WaitCursor
        Call saveTxtFile()
        Dim OBJNew As New Form_Make_Order_Mobile
        OBJNew.Name = "InvoiceMobileViewOrder"
    ...
    Private Sub cmdOkView_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdOkView.Click
        If BTNRemove.Enabled = True Then Call saveTxtFile()
        Me.Close()
    End Sub
